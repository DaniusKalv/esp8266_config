...
htmlflash: html
	$(Q) if [ $$(stat -c '%s' html/wfiSSIDSetupMinify.html) -gt $$(( $(HTML_SIZE) )) ]; then echo "wfiSSIDSetupMinify.html too big!"; false; fi
	$(ESPTOOL) -p $(ESPPORT) -b $(BAUD) write_flash $(flashimageoptions) $(HTML_POS) html/wfiSSIDSetupMinify.html
